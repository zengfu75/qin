<template>
  <div>
    <el-form :inline="true" ref="filterForm" :model="filterForm" label-width="110px" class="waybillForm"> 
        ...
        <el-form-item  prop="logisticsCode" label="始发省份">
          <el-select v-model="filterForm.originProvince" placeholder="请选择">
            <el-option
        ...
        <el-form-item  prop="logisticsCode" label="目的省份">
          <el-select v-model="filterForm.receivedProvince" placeholder="请选择">
            <el-option
              v-for="item in Logistics"
              :key="item.value"
              :label="item.text"
        ...
        <el-form-item label="发货日期">
          <el-date-picker
            v-model="filterForm.shipmentDateStart"
            type="date"
            placeholder="选择日期"
            default-value="2010-10-01">
          </el-date-picker>
          -
          <el-date-picker
            v-model="filterForm.createTimeStartEnd"
            type="date"
            placeholder="选择日期"
            default-value="2010-10-01">
          </el-date-picker>
  ...
  data(){
    return {
      ...
      tableData: [{
          ...
          receivedProvince:"内蒙古自治",
          originProvince:"内蒙古自治",
          platform:"平台",
          logisticsCode:"韵达",
